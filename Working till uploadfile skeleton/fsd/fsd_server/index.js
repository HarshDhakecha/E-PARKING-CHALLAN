...
app.use('/', require("../fsd_server/Routes/processPayment"))
app.use('/', require("../fsd_server/Routes/getDetailsbyNP"))
app.use('/', require("../fsd_server/Routes/notifyEmail"))
app.use('/', require("../fsd_server/Routes/sendAnnounceMail"))